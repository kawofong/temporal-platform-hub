---
id: explain-temporal-concepts
title: Explain Temporal Concepts
sidebar_label: 📚 Explain Temporal Concepts
description: Get plain-language explanations of Temporal's core concepts tailored to your background.
---
...
[Choose what applies:]
- Workflows vs. Activities — what's the difference and why does it matter?
- Workers — what do they do and how do they connect to Temporal?
- Task Queues — how does work get routed to the right worker?
- Durable execution — what does it mean and why is it valuable?
- The event history — how does Temporal remember what happened?
...
- Specify your background precisely — the quality of analogies varies a lot based on this.
